    ...
    public void loadFragment(MenuItem menuItem)
    {
    	...
    	switch (menuItem.getItemId()) 
        {
            case R.id.nav_third_fragment:
    			...
    			transaction.replace(R.id.flContent, musicFragment, 0 + "");
    			transaction.addToBackStack(0 + "");// 
                break;
            case R.id.nav_second_fragment:
            	if(myMusicFragment == null)
        			myMusicFragment = new MyMusicFragment();
        		transaction.replace(R.id.flContent, myMusicFragment, "1");
            ...
            case R.id.nav_fourth_fragment:
            	transaction.replace(R.id.flContent, setFragment, "3");
