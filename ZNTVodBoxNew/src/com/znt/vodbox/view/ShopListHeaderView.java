...
import com.znt.vodbox.activity.AddDeviceActivity;
import com.znt.vodbox.activity.LevelShopActivity;
...
public class ShopListHeaderView extends RelativeLayout
{
	...
	private void initViews(Context context)
	{
		...
		viewAdd.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				ViewUtils.startActivity(mContext, AddDeviceActivity.class, null);
			}
		});
		viewAream.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				ViewUtils.startActivity(mContext, LevelShopActivity.class, null);
			}
		});
