...
public abstract class BaseFragment extends Fragment
{
	...
	*/
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		toolbar = (Toolbar) parentView.findViewById(R.id.tool_bar_base);
		getActivity().getLayoutInflater().inflate(R.layout.activity_base_tool_bar, toolbar);
	...
	public boolean isOnline(boolean showInfor)
	{
		...
		//0,鏃犵綉缁滆繛鎺�  1锛岃繛鎺ョ殑鏄疻IFI鐑偣 2锛屾甯歌繛鎺�
