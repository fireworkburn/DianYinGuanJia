...
public class MusicSearchAdapter  extends BaseAdapter
{
	...
	private Handler handler = new Handler()
	{
		public void handleMessage(android.os.Message msg) 
		{
			...
			{
				Toast.makeText(mContext, "操作成功", 0).show();
			...
			else if(msg.what == HttpMsg.PUSH_MUSIC_SUCCESS)
			{
				new Handler().postDelayed(new Runnable() {
					...
					public void run() {
						...
						Toast.makeText(mContext, "插播成功", 0).show();
						dismissDialog();
					}
							...
							new Thread(new Runnable() 
							{
								...
								public void run() 
								{
									...
									mContext.runOnUiThread(new Runnable() {
										...
										public void run() {
											// TODO Auto-generated method stub
											showProgressDialog(mContext, "正在检测歌曲信息．．．");
										}
									});
									...
									mContext.runOnUiThread(new Runnable() 
									{
										...
										public void run() 
										{
											...
											if(isUrlValid)
											{
												...
												Toast.makeText(mContext, "歌曲已失效", 0).show();
											isCheckUrl = false;
										}
									});
								}
